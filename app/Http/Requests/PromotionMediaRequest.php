...
class PromotionMediaRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'cover_image.mimes' => 'Only jpg, jpeg, png, gif, webp images and mp4 videos are allowed for the cover image.',
            'cover_image.max' => 'The cover image size must not exceed 5MB.',
        ];
    }
}
