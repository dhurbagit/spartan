...
var updateOutput = function (e) {
  ...
  var nestableList = $("#nestable1 > .dd-list");
  ...
  var deleteFromMenuHelper = function (target) {
    if (target.data('new') == 1) {
      ...
      target.fadeOut(function () {
        target.remove();
        updateOutput($('#nestable1').data('output', $('#json-output')));
      });
    } else {
  ...
  var addToMenu = function () {
    ...
    // set events
    $("#nestable1 .button-delete").on("click", deleteFromMenu);
    $("#nestable1 .button-edit").on("click", prepareEdit);
  };
