...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="{{ route('vacancy.create') }}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
            <i class="fa fa-plus-square" aria-hidden="true"></i>
            Create New Vacancy</a>
    </div>
    <div class="row">
        <div class="col-lg-12">
            <!-- DataTales Example -->
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Vacancy list</h6>
                </div>
                <div class="card-body">
                                ...
                                @if (isset($data) && $data->count() > 0)
                                    @foreach ($data as $record => $customers)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('vacancy.edit', $customers->id) }}" class="btn btn-primary">
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <form action="{{ route('vacancy.destroy', $customers->id) }}"
                                                                    method="POST">
                                                                    @csrf
                                                                    @method('delete')
                                                                    <button type="submit"
